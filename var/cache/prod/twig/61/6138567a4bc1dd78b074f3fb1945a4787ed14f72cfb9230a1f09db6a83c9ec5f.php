...
array_key_exists("origin", $context)) ? (_twig_default_filter((isset($context["origin"]) ? $context["origin"] : null), "none")) : ("none")))));
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Module/Includes:grid_notification_update.html.twig", "D:\\wamp64\\www\\presta\\src\\PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_notification_update.html.twig");
    }
}
